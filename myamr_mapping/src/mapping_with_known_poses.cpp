...
#include "myamr_mapping/mapping_with_known_poses.hpp"
...
int main(int argc, char *argv[])
{
    ...
    auto node = std::make_shared<myamr_mapping::MappingWithKnownPoses>("mapping_with_known_poses");
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}
