...
# Handle NumPy compatibility issue with tf_transformations
try:
    from tf_transformations import quaternion_from_euler
except AttributeError:
    # Fallback implementation for NumPy compatibility
...
class NoisyController(Node):
    ...
    def __init__(self):
        ...
        self.odom_pub_ = self.create_publisher(Odometry, "autonombot_drivers/odom_noisy", 10)
